...
namespace E_Library.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(E_LibraryContext context)
        {
            _context = context;
        }
        ...
        {
            var e_LibraryContext = _context.Review.Include(r => r.Book);
            return View(await e_LibraryContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'E_LibraryContext.Review'  is null.");
            }
            var review = await _context.Review.FindAsync(id);
            if (review != null)
            {
